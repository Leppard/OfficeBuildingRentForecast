...
tree_reg = DecisionTreeRegressor(max_depth=2 ,max_leaf_nodes=11)
tree_reg.fit(train_rent_prepared, train_labels_anjuke)
predict = tree_reg.predict(test_rent_prepared)


#################################
from sklearn.model_selection import GridSearchCV
param_grid=[{'max_depth':[x for x in range(1, 20)],'max_leaf_nodes':[x for x in range(10, 50)]}]
...
print(tree_reg.tree_.node_count)