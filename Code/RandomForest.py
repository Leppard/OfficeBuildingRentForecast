...
forest_reg = RandomForestRegressor(n_estimators=100, max_features=4, bootstrap=False)
forest_reg.fit(train_rent_prepared, train_labels_anjuke)
predict = forest_reg.predict(test_rent_prepared)


################################
# from sklearn.model_selection import GridSearchCV
# param_grid=[
#         {'n_estimators': [10, 30, 50, 80, 100], 'max_features': [2, 4, 6, 8, 10]},
#         {'bootstrap': [False], 'n_estimators': [10, 30, 50, 80, 100], 'max_features': [2, 4, 6, 8, 10]}
#                     ]
#
